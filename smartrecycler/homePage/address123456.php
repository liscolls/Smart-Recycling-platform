 ...
 if($type=='edit'){
  ...
  //list ($stat,$acc,$north,$east) = explode(",",$location[0]);
       ...
       if($type=='edit'){
			...
			echo $ins ="INSERT INTO address (IDCity,streetAddress,latitute,longitute)values('$_REQUEST[IDCity]','$_REQUEST[streetAddress]','$north','$east')";
			mysql_query($ins);
			}
			}
...
<div id="wrapper">
	...
	<div id="mylogo">
		...
		<div>
			<SELECT STYLE="width:190px" name ="IDCity">
